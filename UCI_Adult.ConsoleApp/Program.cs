...
namespace UCI_Adult.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\xiaoyuz\Desktop\UCI_Adult.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Using model to make single prediction -- Comparing actual Label_IsOver50K_ with predicted Label_IsOver50K_ from sample data...\n\n");
            ...
            Console.WriteLine($"\n\nActual Label_IsOver50K_: {sampleData.Label_IsOver50K_} \nPredicted Label_IsOver50K_ value {predictionResult.Prediction} \nPredicted Label_IsOver50K_ scores: [{String.Join(",", predictionResult.Score)}]\n\n");
