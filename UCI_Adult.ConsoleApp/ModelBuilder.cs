...
// This code demonstrates how to get an ML.NET model from the model produced from Azure training.
using System;
...
namespace UCI_Adult.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\xiaoyuz\Desktop\UCI_Adult.csv";
        private static string MLNET_MODEL = @"C:\Users\xiaoyuz\Desktop\UCI_Adult\UCI_Adult.Model\MLModel.zip";
        private static string ONNX_MODEL = @"C:\Users\xiaoyuz\Desktop\UCI_Adult\UCI_Adult.Model\bestModel.onnx";

        // Create MLContext to be shared across the model creation workflow objects 
        // Set a random seed for repeatable/deterministic results across multiple trainings.
        private static MLContext mlContext = new MLContext(seed: 1);

         // Training in Azure produces an ONNX model, so this method creates an ML.NET model (MLModel.zip) from the trained ONNX  model (bestModel.onnx)
